# ===================================================================
# Injetor Reflexivo de DLL via PowerShell v1.3 (Versão Canônica)
# ===================================================================
...
try {
    ...
    # Pausa para o usuário ver o erro
...
$codigoInjetor = @"
// Adicionados os 'usings' necessários para o compilador do PowerShell
using System;
...
public class Reflector
{
    ...
    public static void Inject(byte[] dllBytes)
    {
        ...
        try
        {
            ...
            // CORREÇÃO APLICADA: Declarar a variável 'threadId' antes de usá-la com 'out'
            IntPtr threadId;
